...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": `${siteUrl}/#davide`,
      name: "Davide",
      jobTitle: "Video editor e creative strategist",
      worksFor: { "@id": `${siteUrl}/#organization` },
      sameAs: [instagram],
      description:
        "Davide segue personalmente strategia, copywriting, montaggio e revisioni dei progetti Edge Visuals.",
      knowsAbout: [
        "Video editing",
        "Motion graphics",
        "Copywriting per video brevi",
        "Storytelling",
